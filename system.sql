...
) ENGINE=InnoDB AUTO_INCREMENT=55 DEFAULT CHARSET=utf8mb4 COMMENT='应用表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='工具栏按钮表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sys_role` VALUES (1,'admin',0,NULL),(2,'user',0,NULL),(3,'管理员',0,NULL);
...
CREATE TABLE `sys_user` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `UNI_SYS_USER_USERNAME_STATUS` (`username`,`status`) USING BTREE
...
INSERT INTO `sys_user_role` VALUES (1,1),(1,2),(1,3);
...
-- Dump completed on 2019-05-27  9:57:25
